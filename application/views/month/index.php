    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                <h2><a href="<?php echo site_url('Month') ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Month</a></h2>
                </div>
            </div>
                                            ...
                                            if (!empty($monthlist)) {
                                                ...
                                                foreach ($monthlist as $list) {  ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('Month/') . 'editmonth/' . $list->MonthId ?>" class="btn btn-success btn-circle"><i class="fa fa-edit"></i>
                                                            </a>

                                                            <button class="btn btn-danger btn-circle" type="button" onclick="showConfirmation('<?php echo $list->MonthId ?>')"><i class="fa fa-trash"></i>
                                                            </button>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                ...
                                <form id="<?php echo ($editMonth)? "updatemonth":"addmonth" ?>" action="<?php echo base_url() . 'UserRoles/add'; ?>" method="post">
                                    <div class="form-group">
                                        <label for="">Title <span class="text-danger">*</span></label>
                                        <input type="hidden" name="Id" value="<?php echo ($editMonth) ? $editMonth->MonthId : ''; ?>">
                                        <input type="text" class="form-control" name="title" required value="<?php echo ($editMonth) ? $editMonth->Title : ''; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            <option value="1" <?php echo ($editMonth) ? (($editMonth->Status == 1) ? 'selected' : '') : ''; ?>>Active</option>
                                            <option value="0" <?php echo ($editMonth) ? (($editMonth->Status == 0) ? 'selected' : '') : ''; ?>>Inactive</option>
                                        </select>
                                    </div>

                                    <div class="form-group ">

                                        <button type="submit" id="<?php echo $editMonth ? 'update' : 'save'; ?>" class="btn btn-success ladda-button ladda-button-demo" <?php if ($editMonth) { ?> formaction='<?php echo base_url('updateemployee') ?>' <?php } ?>>
                                            <i class="fa fa-bookmark"></i> <?php echo $editMonth ? 'Update' : 'Add'; ?>
                                        </button>
...
function performAjaxFunction(global_var) {
            ...
            $.ajax({
                url: '<?php echo base_url() . 'Month/deletemonth'; ?>',
                method: 'POST',
                data: {
                    id: global_var
                },
                success: function(data) {
                    ...
                    var $toast = toastr['success']('Month successfully deleted');
                    setTimeout(function() {
                        location.reload();
                    }, 2000)
                },
                error: function(error) {
                    ...
                    var $toast = toastr['error']('Month not  deleted');
    ...
    <?php $this->load->view('Month/monthjs'); ?>
