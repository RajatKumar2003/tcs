                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                               ...
                                               <input type="email" name="email" class="form-control" value="<?php echo ($editseo)? $editseo->Email : '' ?>">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="website" class="form-control" value="<?php echo ($editseo) ? $editseo->Website : ''; ?>">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="gstno" class="form-control" value="<?php echo ($editseo) ? $editseo->GstNo : ''; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                           ...
                                           <input type="text" name="cinno" class="form-control" value="<?php echo ($editseo) ? $editseo->CinNo : ''; ?>">
                                           </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                           ...
                                           <label for="">PAN No</label>
                                            ...
                                            <input type="text" name="panno" class="form-control" value="<?php echo ($editseo) ? $editseo->PanNo : ''; ?>">
                                           </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <textarea name="address" id="" class="form-control"><?php echo ($editseo) ? $editseo->Address : ''; ?></textarea>
                                        </div>
