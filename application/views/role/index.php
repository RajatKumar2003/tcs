    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                <h2><a href="<?php echo site_url('Role') ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Role</a></h2>
                </div>
            </div>
                                            ...
                                            if (!empty($rolelist)) {
                                                ...
                                                foreach ($rolelist as $list) {  ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('Role/') . 'editrole/' . $list->RoleId ?>" class="btn btn-success btn-circle"><i class="fa fa-edit"></i>
                                                            </a>

                                                            <button class="btn btn-danger btn-circle" type="button" onclick="showConfirmation('<?php echo $list->RoleId ?>')"><i class="fa fa-trash"></i>
                                                            </button>
                    ...
                    <div class="col-lg-4">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                ...
                                <form id="<?php echo ($editRole)? "updaterole":"addrole" ?>" action="<?php echo base_url() . 'UserRoles/add'; ?>" method="post">
                                    <div class="form-group">
                                        <label for="">Title <span class="text-danger">*</span></label>
                                        <input type="hidden" name="Id" value="<?php echo ($editRole) ? $editRole->RoleId : ''; ?>">
                                        <input type="text" required class="form-control" name="title" value="<?php echo ($editRole) ? $editRole->Title : ''; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            <option value="1" <?php echo ($editRole) ? (($editRole->Status == 1) ? 'selected' : '') : ''; ?>>Active</option>
                                            <option value="0" <?php echo ($editRole) ? (($editRole->Status == 0) ? 'selected' : '') : ''; ?>>Inactive</option>
                                        </select>
                                    </div>

                                    <div class="form-group ">

                                        <button type="submit" id="<?php echo $editRole ? 'update' : 'save'; ?>" class="btn btn-success ladda-button ladda-button-demo" <?php if ($editRole) { ?> formaction='<?php echo base_url('updateemployee') ?>' <?php } ?>>
                                            <i class="fa fa-bookmark"></i> <?php echo $editRole ? 'Update' : 'Add'; ?>
                                        </button>
...
function performAjaxFunction(global_var) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var $toast = toastr['success']('Role successfully deleted');
                    setTimeout(function() {
                        location.reload();
                    }, 2000)
                },
                error: function(error) {
                    ...
                    var $toast = toastr['error']('Role not  deleted');
    ...
    <?php $this->load->view('Role/rolejs'); ?>
