    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                    <h2><a href="<?php echo site_url('Invoice') ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Invoice</a></h2>
                </div>
            </div>
                    ...
                    <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                ...
                                <form id="<?php echo ($editUser) ? "updateuser" : "addinvoice" ?>" action="<?php echo base_url() . 'UserRoles/add'; ?>" method="post">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <option value="">select month</option>
                                                        ...
                                                        ?>
                                                                ...
                                                                <option value="<?= $list->Title ?>" data-month="<?= $i++; ?>"><?= $list->Title ?></option>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <option value="">select place</option>
                                                        ...
                                                        ?>
                                                                ...
                                                                <option value="<?= $list->Title ?>" data-cgst="<?= $list->Cgst ?>" data-sgst="<?= $list->Sgst ?>" data-igst="<?= $list->Igst ?>">
                                                                    <?= $list->Title ?></option>
                                                            ...
                                                            <table class="table table-striped table-bordered table-hover  issue-tracker  " id="myTable">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><input type="number" class="form-control rate" name="Rate[]" required></td>
                                                                        <td><input type="number" class="form-control qty" name="Qty[]"></td>
                                                                      
                                                                        <td><input type="number" class="form-control mandays" name="ManDays[]" required></td>
                                                                       
                                                                        <td><input type="hidden" name="Amount[]" id="amount"> <span class="amount">0.000</span> </td>
                                                                        <td><button class="add-row" type="button" style="background-color: transparent; border: none;"><i class="fa fa-plus btn btn-circle btn-primary"></i></button></td>
                                                                    </tr>
                                                                </tbody>
                                                ...
                                                foreach ($invoicelist as $list) {  ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?= base_url('Invoice/').'printinvoice/'.$list->InvoiceId; ?>" target="_blank" class="btn btn-warning btn-circle"><i class="fa fa-file-photo-o "></i></a>
