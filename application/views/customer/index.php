                ...
                <div class="col-lg-12">
                        <div class="ibox float-e-margins">
                            <div class="ibox-content">
                                ...
                                <form id="<?php echo ($editCustomer)? "updatecustomer":"addcustomer" ?>" action="<?php echo base_url() . 'UserRoles/add'; ?>" method="post">
                                ...
                                <fieldset>
                                           ...
                                           <select name="status" id="" class="form-control">
                                            <option value="1" <?php echo ($editCustomer) ? (($editCustomer->Status == 1) ? 'selected' : '') : ''; ?>>Active</option>
                                            <option value="0" <?php echo ($editCustomer) ? (($editCustomer->Status == 0) ? 'selected' : '') : ''; ?>>Inactive</option>
                                        </select>
                                           </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" name="email" class="form-control" value="<?php echo ($editCustomer) ? $editCustomer->Email : ''; ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="contactnumber" value="<?php echo ($editCustomer) ? $editCustomer->ContactNumber : ''; ?>">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row" style="margin-top: 20px;">
                                                ...
                                                <button type="submit" id="<?php echo $editCustomer ? 'update' : 'save'; ?>" class="btn btn-success ladda-button ladda-button-demo fa-pull-right" <?php if ($editCustomer) { ?> formaction='<?php echo base_url('updateemployee') ?>' <?php } ?>>
                                            <i class="fa fa-bookmark"></i> <?php echo $editCustomer ? 'Update' : 'Add'; ?>
                                        </button>
                                            ...
                                            if (!empty($customerlist)) {
                                                ...
                                                foreach ($customerlist as $list) {  ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('Customer/') . 'editcustomer/' . $list->CustId ?>" class="btn btn-success btn-circle"><i class="fa fa-edit"></i>
                                                            </a>
...
function performAjaxFunction(global_var) {
    ...
    <?php $this->load->view('Customer/customerjs'); ?>
    <script>
        $(document).ready(function(){
