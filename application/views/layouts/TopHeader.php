...
<link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url('uploads/seo/').$editseo->Favicon; ?>">
<title><?php echo $editseo->SiteTitle; ?> | <?php echo $pagename; ?></title>
...
<link href="<?php echo base_url('assets/admin/') ?>css/plugins/ladda/ladda-themeless.min.css" rel="stylesheet">
