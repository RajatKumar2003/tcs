        ...
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                        <img alt="image" class="img-circle" src="<?php echo base_url('uploads/seo/').$editseo->Logo; ?>" / width="170px">
                    </span>
         ...
         ?> 
            ...
            <li>
                ...
                <ul class="nav nav-second-level collapse">
                    <li>
                        <a href="<?php echo site_url('Month') ?>"> <span class="nav-label">Month</span> </span></a>
                    </li>

                    <li>
                        <a href="<?php echo site_url('Year') ?>"> <span class="nav-label">Year</span> </span></a>
                    </li>

                    <li>
                        <a href="<?php echo site_url('State') ?>"><span class="nav-label">State</span></a>
                    </li>
