    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                <h2><a href="<?php echo site_url('Description') ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Description</a></h2>
                </div>
            </div>
                                            ...
                                            if (!empty($descriptionlist)) {
                                                ...
                                                foreach ($descriptionlist as $list) {  ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('Description/') . 'editdescription/' . $list->DescId ?>" class="btn btn-success btn-circle"><i class="fa fa-edit"></i>
                                                            </a>

                                                            <button class="btn btn-danger btn-circle" type="button" onclick="showConfirmation('<?php echo $list->DescId ?>')"><i class="fa fa-trash"></i>
                                                            </button>
                            ...
                            <div class="ibox-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" id="" class="form-control">
                                        ...
                                        {
                                            foreach($descriptioncategory as $list)
                                            { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="" class="form-control">
                                            <option value="1" <?php echo ($editDescription) ? (($editDescription->Status == 1) ? 'selected' : '') : ''; ?>>Active</option>
                                            <option value="0" <?php echo ($editDescription) ? (($editDescription->Status == 0) ? 'selected' : '') : ''; ?>>Inactive</option>
                                        </select>
                                    </div>

                                    <div class="form-group ">

                                        <button type="submit" id="<?php echo $editDescription ? 'update' : 'save'; ?>" class="btn btn-success ladda-button ladda-button-demo" <?php if ($editDescription) { ?> formaction='<?php echo base_url('updateemployee') ?>' <?php } ?>>
                                            <i class="fa fa-bookmark"></i> <?php echo $editDescription ? 'Update' : 'Add'; ?>
                                        </button>
...
function performAjaxFunction(global_var) {
            ...
            $.ajax({
                url: '<?php echo base_url() . 'Description/deletedescription'; ?>',
                method: 'POST',
                data: {
                    id: global_var
                },
                success: function(data) {
                    ...
                    var $toast = toastr['success']('Description successfully deleted');
                    setTimeout(function() {
                        location.reload();
                    }, 2000)
                },
                error: function(error) {
                    ...
                    var $toast = toastr['error']('Description not  deleted');
    ...
    <?php $this->load->view('Description/descriptionjs'); ?>
