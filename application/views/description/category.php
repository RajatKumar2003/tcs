    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-2">
                <h2><a href="<?php echo site_url('Description/category') ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Add Category</a></h2>
                </div>
            </div>
                                            ...
                                            if (!empty($categorylist)) {
                                                ...
                                                foreach ($categorylist as $list) {  ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo base_url('Description/') . 'editcategory/' . $list->CatId ?>" class="btn btn-success btn-circle"><i class="fa fa-edit"></i>
                                                            </a>
...
function performAjaxFunction(global_var) {
            ...
            $.ajax({
                url: '<?php echo base_url() . 'Description/deletecategory'; ?>',
                method: 'POST',
                data: {
                    id: global_var
                },
                ...
                error: function(error) {
                    ...
                    var $toast = toastr['error']('Category not  deleted');
    ...
    <?php $this->load->view('Description/categoryjs'); ?>
