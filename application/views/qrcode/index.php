...
<body>
                                ...
                                <div class="ibox">
                                    <div class="ibox-content product-box">
                                        ...
                                        <div class="product-imitation" style="padding: 0;">
                                            <img src="<?php echo base_url('uploads/qrcode/') . $gallery->ImagePath; ?>" alt="" class="img-fluid" width="100%" height="300px">
                                        </div>
                                        <div class="product-desc">
                                            ...
                                            <a href="#" class="product-name"><?php
                                                ...
                                                <span class="fa-pull-right" onclick="showConfirmation('<?php echo $gallery->QrId ?>')"><i class="fa fa-trash btn btn-danger"></i></span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        function uploadimage() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url() . 'Qrcode/savegallery' ?>',
                data: formData,
                contentType: false,
                processData: false,
        ...
        function performAjaxFunction(global_var) {
            ...
            $.ajax({
                url: '<?php echo base_url() . 'Qrcode/deletegallery'; ?>',
                method: 'POST',
                data: {
                    id: global_var
                },
